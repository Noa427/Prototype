...
import { Bell, Search, User, LogOut, Shield, UserCheck, CheckCheck, Trash2, Menu } from 'lucide-react';
...
export const Header = ({ onMenuToggle }) => {
    ...
    return (
        <header className="h-16 glass border-b border-white/5 flex items-center px-4 md:px-8 sticky top-0 z-10">
            {/* Hamburger — mobile only */}
            <button
                onClick={onMenuToggle}
                className="md:hidden p-2 mr-2 text-accent-steel hover:text-white transition-colors"
                aria-label="Menu"
            >
